...
files="bashrc vimrc gitconfig wgetrc screenrc XCompose ssh/config bash_functions config/htop/htoprc config/parcellite/parcelliterc alias psqlrc"    # list of files/folders to symlink in homedir
##########
